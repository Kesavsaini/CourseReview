  ...
  return (
    ...
    <div className='flex items-center justify-between z-50'>
     ...
     <div className='w-12 h-12 rounded-full'>
        <img src="https://cdnb.artstation.com/p/media_assets/images/images/001/016/635/large/Final_copy.jpg?1667758461" alt="" className='w-12 h-12 rounded-full bg-cover'/>
     </div>
     </div>
    </div>
  )
