...
const TopCourseCard = () => {
  return (
    <div className=' w-[90%] shadow rounded-xl p-5 sm:w-80 sm:h-auto'>
    <img src="https://leverageedublog.s3.ap-south-1.amazonaws.com/blog/wp-content/uploads/2020/03/24185535/Online-Learning.jpg" alt="" className='rounded-xl' />
