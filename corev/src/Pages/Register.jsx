      ...
      <div className="form ml-5 p-5 mt-4 mr-3 shadow-2xl rounded-md sm:w-[35%] sm:justify-center sm:items-center">
        <form>
          <div className="input-container flex flex-col mt-5 text-zinc-700">
            ...
            <input type="text" name="uname" required placeholder='Enter your Name' className='border border-solid h-10 mt-2 rounded-sm shadow-lg' />
          </div>
          <div className="input-container flex flex-col mt-5 text-zinc-700">
          ...
          <div className="button-container flex justify-center">
            <button className='w-80 bg-blue-600 text-white flex justify-center px-10 py-3 rounded-3xl mx sm:rounded-full font-semibold justify-center my-6 mt-10 sm:m-1 sm:p-2 sm:my-5 sm:hover:bg-white sm:hover:text-blue-600 hover:outline-offset-2'>Register</button>
          </div>
        </form>
      </div>
      </div>
